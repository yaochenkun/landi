    ...
    <div class="nav-second">
        <div class="toolbar">
            <div class="nav-secondul">
                ...
                <li class="linormal"><a href="">租客一览表</a></li> 
                </ul>
            </div>    
        </div>
    </div>
	    ...
	    <div class="general-map">
	        <table class="table table-bordered" style="border-top:none;border-right:none;" id="building">
	            <tr>
	              ...
	              <td style="border-top:1px solid #dddddd;" colspan="2" id="W35-1">姓名<br></td>
	              <td style="border-top:1px solid #dddddd;" id="W35-2">姓名</td>
	              <td rowspan="66"></td>
	              <td style="border-top:1px solid #dddddd;" id="E35-2"></td>
	              <td style="border-top:1px solid #dddddd;" colspan="2" id="E35-1"></td>
	              <td rowspan="2" colspan="2"></td>
	            </tr>
	            <tr>
	              <td style="border-top:none;" colspan="2"><a href="javascript:void(0);">W35-1</a></td>
	              <td style="border-top:none;"><a href="javascript:void(0);">W35-2</a></td>
	              <td style="border-top:none;"><a href="javascript:void(0);">E35-2</a></td>
	              <td style="border-top:none;" colspan="2"><a href="javascript:void(0);">E35-1</a></td>
	            </tr>
	        </table>
	   </div>
   </div>
