...
<body>
		...
		<div class="main-page">
			<div class="nav-path">
				<a href="../roomServiceIndex.jsp" title="回到首页"><i
					...
					href="serviceWaterBill.jsp">桶装水费</a>
			</div>
			...
			<div class="bill-area">
				<div class="bill-table">
					...
					<table>
									...
									<div class="search-roomNo">
										<div class="search-wrap">
											<input type="text" class="search-input"
												...
												style="right: 130px;"></a> <a class="btn btn-edit btnedit"
												onclick="requestFirstWaterBillByRoomNum(this)">搜索桶装水费</a>
										</div>
									</div></th>
								<th><span>客人姓名</span>
						...
						<tbody id="waterBillTbody"></tbody>
					</table>
					<!-- 费用 table end -->

					<!-- 底部页面 start -->
					<div id="serviceWaterBillBottom" class="bottom"></div>
					<!-- 底部页码 end -->
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/ld/user/roomService/service/serviceWaterBill.js"></script>
	<script type="text/javascript">
	    // 拉取第一页 桶装水费信息
		requestFirstWaterBill();
	</script>
</body>
</html>