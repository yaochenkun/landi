...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/ld/user/roomService/service/serviceIndex.css"
	rel="stylesheet" type="text/css" />
<title>客房服务</title>
</head>
<body>
				...
				<div class="content-title content-title-index">
					<ul>
						<li><div class="icon"></div>
							<a href="">洗衣单收费</a></li>
						<li><div class="icon"></div>
							<a href="serviceTakeaway.jsp">餐费</a></li>
						<li><div class="icon"></div>
							<a href="serviceWaterBill.jsp">桶装水费</a></li>
						<li><div class="icon"></div>
							<a href="serviceShoeCleaning.jsp">擦鞋费</a></li>
						<li><div class="icon"></div>
							<a href="serviceShopping.jsp">代购费</a></li>
						<li><div class="icon"></div>
							<a href="">车费</a></li>
					</ul>
				</div>
